Module.register("currentweather_plus",{
	defaults: {
		location: false,
		locationID: false,
		appid: "",
	...
	addExtraInfoWeather: function(wrapper) {
		...
		if (this.config.showWindDirection) {
			...
			if (this.config.showWindDirectionAsArrow) {
				...
				windDirection.className = "wiswd";
				windDirection.innerHTML = this.translate(this.windDirection) + "<sup> </sup>";
			}
		...
		if (this.config.showVisibility) {
			...
			visibility.innerHTML = "<i class=\"wi wi-alien\"></i>" + this.visibility / 1000 + "<sub> km</sub> ";
	...
	getDom: function() {
		...
		if (this.config.hideTemp === false) {
			...
			weatherIcon.className = "wicon wi " + this.weatherType;
		...
		if (this.config.showFeelsLike && this.config.onlyTemp === false) {
			...
			if (this.config.showMinMax) {
	    		...
	    		if ((isNaN(this.rain)) || (isNaN(this.snow))) {
					...
					rains.innerHTML = "&nbsp; <i class=\"wi wi-snowflake-cold lightblue\"></i>&nbsp;" + parseFloat(this.snow["1h"] || this.snow["3h"]).toFixed(1).replace(".", this.config.decimalSymbol) + "&nbsp;mm";
				} else if (isNaN(this.snow)) {
					rains.innerHTML = "&nbsp; <i class=\"wi wi-umbrella yellow\"></i>&nbsp;" + parseFloat(this.rain["1h"] || this.rain["3h"]).toFixed(1).replace(".", this.config.decimalSymbol) + "&nbsp;mm";
				}
